  ...
  return (
    <section className=" bg-black text-white">
      <div className="layout">
        <h1 className="py-10 pr-5 text-2xl md:px-10 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          {/* left side grid */}
          <div className="grid grid-cols-2 md:mr-8 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="md:border-l-[0.5px]">
            <div className="flex flex-col md:items-center">
              <h2 className="my-7 text-xs opacity-60">A FEW MORE</h2>
